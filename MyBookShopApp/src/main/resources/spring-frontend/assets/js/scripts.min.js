            ...
            return {
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/books/changeBookStatus/bookReview', {
                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result) {
                                        ...
                                        $row.find('.form-input-code').addClass('form-input_error').after('<div class="form-error">' + 'Wrong code or phone number!' + '</div>');
                                    } else {
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        var $this = $(this), check = $this.prop('checked'), data = {};
                        data.value = (check ? $this.val() : 0);
                        // Login().postData('/books/rateBookReview/' + $('[data-bookslug]').data('bookslug'), data, function (result)
                        Login().postData('/books/changeBookStatus/vote/' + $this.data('bookid'), data, function (result) {
