...
public class Book {
    ...
    @ApiModelProperty("A date when a book was published")
    ...
    @ApiModelProperty("if isBestseller = 1, the book considered to be bestseller and if 0 books is not a bestseller")
    ...
    @ApiModelProperty("book purchase amount")
    private Long purchaseAmount;

    @Column(name = "in_cart_amount")
    @JsonProperty("in_cart_amount")
    @ApiModelProperty("book amount in cart")
    private Long inCartAmount;

    @Column(name = "postponed_amount")
    @JsonProperty("postponed_amount")
    @ApiModelProperty("book postponed amount")
